...
public class JavaDescriptionCandidate extends PluginDescription {
    ...
    public JavaDescriptionCandidate(String id, @Nullable String name, @Nullable String version,
        @Nullable String description, @Nullable List<String> authors, Collection<PluginDependency> dependencies,
