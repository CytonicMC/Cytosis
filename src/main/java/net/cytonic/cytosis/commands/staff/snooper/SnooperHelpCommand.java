...
public class SnooperHelpCommand extends CytosisCommand {
    public SnooperHelpCommand() {
        ...
        setDefaultExecutor((s, ignored) -> s.sendMessage(
                Msg.mm("<b><#e829aa>SNOOPER HELP!</#e829aa></b><gray> »").appendNewline()
        ...
        addSyntax((s, ctx) -> {
            ...
            switch (command) {
                case "help" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>help</#ee61c0>").appendNewline()
                ...
                case "about" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>about</#ee61c0>").appendNewline()
                                .append(Msg.mm("<gray>Sends a message displaying the basic usage of the snooper system."))
                        );
                case "listen" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>listen</#ee61c0> <channel>").appendNewline()
                ...
                case "blind" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>blind</#ee61c0> <channel>").appendNewline()
                ...
                case "mute" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>mute</#ee61c0>").appendNewline()
                ...
                case "unmute" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>unmute</#ee61c0>").appendNewline()
                                .append(Msg.mm("<gray>Reenables receiving all notifications from snooper. To disable them, use \"/snooper mute\"."))
                        );
                case "audit" ->
                        s.sendMessage(Msg.mm("<b><#e829aa>SNOOPER HELP! </#e829aa></b><gray>» /snooper <#ee61c0>audit</#ee61c0>").appendNewline()
