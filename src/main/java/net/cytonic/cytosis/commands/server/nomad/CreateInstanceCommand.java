...
public class CreateInstanceCommand extends CytosisCommand {
    public CreateInstanceCommand() {
        ...
        typeArg.setCallback((sender, e) -> sender.sendMessage(Msg.whoops("Invalid type! Valid types are: cytosis, cynder")));
        ...
        quantityArg.setCallback((sender, e) -> sender.sendMessage(Msg.whoops("Invalid quantity! Valid quantities are: 1-10")));
        ...
        addSyntax((sender, context) -> {
            ...
            sender.sendMessage(Msg.success("Dispatched the creation of new %s instance! It may take up to 30s to fully start up.", niceName));
        }, typeArg, quantityArg);
    }
}
