...
public class RevokeCommand extends CytosisCommand {
    ...
    public RevokeCommand() {
        ...
        addSyntax((sender, context) -> {
            ...
            try {
                ...
                removeWhiteListSync(target, rawPlayer, player, environment);
            } catch (IllegalArgumentException ex) {
                Thread.ofVirtual().start(() -> {
                    try {
                        removeWhiteList(MojangUtils.getUUID(rawPlayer), rawPlayer, player, environment);
                    } catch (IOException e) {
    ...
    private void removeWhiteListSync(UUID uuid, String msg, CytosisPlayer player, Environment environment) {
        Thread.ofVirtual().start(() -> removeWhiteList(uuid, msg, player, environment));
    }
