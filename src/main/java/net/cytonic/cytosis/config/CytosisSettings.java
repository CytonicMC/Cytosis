...
public final class CytosisSettings {
    ...
    public static void loadEnvironmentVariables() {
        ...
        if (System.getenv("LOG_PLAYER_JOINS") != null)
            CytosisSettings.LOG_PLAYER_JOINS = Boolean.parseBoolean(System.getenv("LOG_PLAYER_JOINS"));
        if (System.getenv("LOG_PLAYER_QUITS") != null)
            CytosisSettings.LOG_PLAYER_QUITS = Boolean.parseBoolean(System.getenv("LOG_PLAYER_QUITS"));
        if (System.getenv("LOG_PLAYER_COMMANDS") != null)
            CytosisSettings.LOG_PLAYER_COMMANDS = Boolean.parseBoolean(System.getenv("LOG_PLAYER_COMMANDS"));
        if (System.getenv("LOG_PLAYER_CHAT") != null)
            CytosisSettings.LOG_PLAYER_CHAT = Boolean.parseBoolean(System.getenv("LOG_PLAYER_CHAT"));
        if (System.getenv("LOG_PLAYER_JOINS") != null)
        ...
        if (System.getenv("SERVER_PROXY_MODE") != null)
            CytosisSettings.SERVER_PROXY_MODE = Boolean.parseBoolean(System.getenv("SERVER_PROXY_MODE"));
