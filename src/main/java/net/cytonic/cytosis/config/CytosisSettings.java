...
public class CytosisSettings {
    ...
    public static void loadEnvironmentVariables() {
        ...
        // logging
        if (!(System.getenv("LOG_PLAYER_IPS") == null))
            LOG_PLAYER_IPS = Boolean.parseBoolean(System.getenv("LOG_PLAYER_IPS"));
    ...
    public static void loadCommandArgs() {
        ...
        // logging
        if (!(System.getProperty("LOG_PLAYER_IPS") == null))
            LOG_PLAYER_IPS = Boolean.parseBoolean(System.getProperty("LOG_PLAYER_IPS"));
