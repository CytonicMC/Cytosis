...
import net.cytonic.cytosis.logging.Color;
import java.util.function.Consumer;

class LoggingLoadingBar implements LoadingBar {

    private static final double PROGRESS_BAR_WIDTH = Integer.parseInt(System.getProperty("cytosis.loadingBarWidth", "20"));
    private static final Color MESSAGE_COLOR = Color.valueOf(System.getProperty("cytosis.loadingBarMessageColor", "BLUE_BOLD"));
