...
public enum PlayerRank {
     ...
     * The [NEXUS] rank
     */
    NEXUS(Msg.mm("<gold>☆</gold> "), NamedTextColor.GOLD, NamedTextColor.WHITE),
    /**
     * The [SYNAPSE] rank
     */
    SYNAPSE(Msg.mm("<dark_green>\uD83D\uDC09</dark_green> "), NamedTextColor.DARK_GREEN, NamedTextColor.WHITE),
    /**
     * The [CORTEX] rank
     */
    CORTEX(Msg.mm("<dark_purple>✞</dark_purple> "), NamedTextColor.DARK_PURPLE, NamedTextColor.WHITE),
    /**
     * The [DEFAULT] rank
     */
